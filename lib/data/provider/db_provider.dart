...
class DBProvider {
  ...
  Future<CurrentWeatherModel?> getCurrentWeather() async {
    ...
    CurrentWeatherModel _currentWeatherModel = CurrentWeatherModel(
      ...
      main: Main(
        temp: _main!.temp,
        feelsLike: _main.feelsLike,
        tempMin: _main.tempMin,
        tempMax: _main.tempMax,
        pressure: _main.pressure,
        humidity: _main.humidity,
        seaLevel: _main.seaLevel,
        grndLevel: _main.grndLevel,
      ),
      ...
      dt: _currentWeather.dt,
      sys: Sys(
        type: _sys!.type,
        id: _sys.id,
        country: _sys.country,
        sunrise: _sys.sunrise,
        sunset: _sys.sunset,
      ),
      timezone: _currentWeather.timezone,
      id: _currentWeather.id,
      name: _currentWeather.name,
      cod: _currentWeather.cod,
    );
